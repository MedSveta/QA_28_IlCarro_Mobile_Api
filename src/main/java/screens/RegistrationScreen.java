...
public class RegistrationScreen extends BaseScreen {
    ...
    @FindBy(xpath =
            "//*[@resource-id='com.telran.ilcarro:id/editRegName']")
    AndroidElement regName;
    @FindBy(xpath = "//*[@resource-id='com.telran" +
            ".ilcarro:id/editRegLastName']")
    AndroidElement regLastName;
    @FindBy(xpath = "//*[@resource-id='com.telran" +
            ".ilcarro:id/editRegEmail']")
    AndroidElement regEmail;
    @FindBy(xpath = "//*[@resource-id='com" +
            ".telran.ilcarro:id/editRegPassword']")
    AndroidElement regPassword;
    @FindBy(xpath = "//*[@resource-id='com.telran" +
            ".ilcarro:id/checkBoxAgree']")
